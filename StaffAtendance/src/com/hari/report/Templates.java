...
public class Templates {
	...
	static {
		...
		HyperLinkBuilder link = hyperLink("http://www.haribabu.com.np");
		dynamicReportsComponent =
		  cmp.horizontalList(
		  	cmp.image(Templates.class.getResource("images/dynamicreports.png")).setFixedDimension(60, 60),
		  	cmp.verticalList(
		  		cmp.text("Staff Reports").setStyle(bold22CenteredStyle).setHorizontalAlignment(HorizontalAlignment.LEFT))).setFixedWidth(300);
